...
# }
# start = 'A'
# print(tsp_brute_force(G, start))  # Prints (14, [('A', 'B', 2), ('B', 'D', 5), ('D', 'C', 4), ('C', 'A', 3)])
#
#
# # Test case 2: 4 nodes
# G = {
...
# }
# start = 'A'
# print(tsp_brute_force(G, start))  # Prints (17, [('A', 'B', 8), ('B', 'C', 5), ('C', 'D', 1), ('D', 'A', 3)])
#
#
# # Test case 3: 5 nodes
# G = {
...
# }
# start = 'A'
# print(tsp_brute_force(G, start))  # Prints (19, [('A', 'C', 3), ('C', 'E', 1), ('E', 'B', 5), ('B', 'D', 4), ('D', 'A', 6)])
#
#
...
# start = 'A'
# t1 = time.time()
# print(tsp_brute_force(G, start))  # Prints (24, [('A', 'G', 9), ('G', 'C', 2), ('C', 'B', 2), ('B', 'D', 2), ('D', 'E', 3), ('E', 'J', 1), ('J', 'I', 2), ('I', 'F', 1), ('F', 'H', 1), ('H', 'A', 1)])
# t2 = time.time()
...
# start = 'A'
# t1 = time.time()
# print(tsp_brute_force(G, start))   # Prints (279, [('A', 'F', 20), ('F', 'B', 14), ('B', 'E', 17), ('E', 'H', 23), ('H', 'K', 18), ('K', 'C', 11), ('C', 'D', 28), ('D', 'I', 8), ('I', 'G', 12), ('G', 'J', 70), ('J', 'A', 58)])
# t2 = time.time()

...
def unit_tests():
    ...
    start = 'A'
    assert atsp_greedy(G, start) == (11, [('A', 'B', 2), ('B', 'D', 5), ('D', 'C', 4)])
    ...
    start = 'A'
    assert atsp_greedy(G, start) == (11, [('A', 'C', 6), ('C', 'B', 3), ('B', 'D', 2)])
    ...
    start = 'A'
    assert atsp_greedy(G, start) == (9, [('A', 'D', 3), ('D', 'C', 1), ('C', 'B', 5)])
    ...
    start = 'A'
    assert atsp_greedy(G, start) == (10, [('A', 'D', 1), ('D', 'C', 5), ('C', 'B', 4)])
    ...
    start = 'A'
    assert atsp_greedy(G, start) == (8, [('A', 'D', 1), ('D', 'C', 2), ('C', 'B', 1), ('B', 'E', 4)])
    ...
    start = 'A'
    assert atsp_greedy(G, start) == (40, [('A', 'B', 10), ('B', 'C', 15), ('C', 'D', 5), ('D', 'E', 10)])
    ...
    start = 'A'
    assert atsp_greedy(G, start) == (12, [('A', 'C', 3), ('C', 'E', 1), ('E', 'D', 4), ('D', 'B', 4)])
    ...
    start = 'A'
    assert atsp_greedy(G, start) == (9, [('A', 'C', 1), ('C', 'F', 2), ('F', 'B', 3), ('B', 'E', 2), ('E', 'D', 1)])
    ...
    start = 'A'
    assert atsp_greedy(G, start) == (11, [('A', 'C', 1), ('C', 'E', 2), ('E', 'B', 3), ('B', 'F', 2), ('F', 'D', 1), ('D', 'G', 2)])
    ...
    start = 'A'
    assert atsp_greedy(G, start) == (14, [('A', 'H', 1), ('H', 'B', 2), ('B', 'C', 3), ('C', 'E', 4), ('E', 'F', 1), ('F', 'D', 2), ('D', 'G', 1)])
    ...
    start = 'A'
    assert atsp_greedy(G, start) == (16, [('A', 'I', 1), ('I', 'B', 2), ('B', 'H', 1), ('H', 'C', 5), ('C', 'G', 1), ('G', 'D', 2), ('D', 'F', 1), ('F', 'E', 3)])
    ...
    start = 'A'
    assert atsp_greedy(G, start) == (23, [('A', 'H', 1), ('H', 'F', 1), ('F', 'I', 1), ('I', 'C', 1), ('C', 'D', 1), ('D', 'B', 2), ('B', 'J', 4), ('J', 'E', 1), ('E', 'G', 11)])
    ...
    start = 'A'
    assert atsp_greedy(G, start) == (259, [('A', 'F', 20), ('F', 'D', 7), ('D', 'I', 8), ('I', 'E', 4), ('E', 'B', 17), ('B', 'G', 58), ('G', 'C', 51), ('C', 'K', 11), ('K', 'H', 18), ('H', 'J', 65)])

...
def unit_tests():
    ...
    start = 'A'
    assert atsp(G, start) == (7, [('A', 'C', 3), ('C', 'B', 4)])
    ...
    start = 'A'
    assert atsp(G, start) == (12, [('A', 'C', 3), ('C', 'E', 1), ('E', 'D', 4), ('D', 'B', 4)])
    ...
    start = 'A'
    assert atsp(G, start) == (250, [('A', 'F', 20), ('F', 'D', 7), ('D', 'I', 8), ('I', 'E', 4), ('E', 'B', 17), ('B', 'L', 16), ('L', 'C', 14), ('C', 'K', 11), ('K', 'H', 18), ('H', 'J', 65), ('J', 'G', 70)])
    assert atsp(G, start, max_brute_force_n=12) == (217, [('A', 'I', 20), ('I', 'G', 12), ('G', 'F', 23), ('F', 'D', 7), ('D', 'C', 28), ('C', 'K', 11), ('K', 'H', 18), ('H', 'E', 23), ('E', 'B', 17), ('B', 'L', 16), ('L', 'J', 42)])

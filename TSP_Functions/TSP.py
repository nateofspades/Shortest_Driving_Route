...
def unit_tests():
    ...
    start = 'A'
    assert tsp(G, start) == (24, [('A', 'B', 12), ('B', 'A', 12)])
    ...
    start = 'A'
    assert tsp(G, start) == (19, [('A', 'B', 12), ('B', 'C', 4), ('C', 'A', 3)])
    ...
    start = 'A'
    assert tsp(G, start) == (19, [('A', 'C', 3), ('C', 'E', 1), ('E', 'B', 5), ('B', 'D', 4), ('D', 'A', 6)])
    ...
    start = 'A'
    assert tsp(G, start) == (303, [('A', 'F', 20), ('F', 'D', 7), ('D', 'I', 8), ('I', 'G', 12), ('G', 'E', 44), ('E', 'H', 23), ('H', 'K', 18), ('K', 'C', 11), ('C', 'L', 14), ('L', 'J', 42), ('J', 'B', 67), ('B', 'A', 37)])
    assert tsp(G, start, max_brute_force_n=12) == (275, [('A', 'I', 20), ('I', 'G', 12), ('G', 'F', 23), ('F', 'D', 7), ('D', 'C', 28), ('C', 'K', 11), ('K', 'H', 18), ('H', 'E', 23), ('E', 'B', 17), ('B', 'L', 16), ('L', 'J', 42), ('J', 'A', 58)])
